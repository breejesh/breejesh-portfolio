    ...
    return {
      ...
      themeVariables: isDark
        ? {
            ...
            // Pie chart colors (maximally distinct, high-contrast chromatic palette)
            pie1: '#64ffda', // Electric Mint (Primary Brand)
            pie2: '#f43f5e', // Vibrant Rose
            pie3: '#3b82f6', // Bright Royal Blue
            pie4: '#eab308', // Warm Gold
            pie5: '#a855f7', // Deep Violet
            pie6: '#f97316', // Tangelo Orange
            pie7: '#06b6d4', // Luminous Cyan
            pie8: '#ec4899', // Hot Fuchsia
            pie9: '#10b981', // Vivid Emerald
            pie10: '#64748b', // Cool Slate (Other Languages)
            pieTitleTextColor: '#64ffda',
            ...
            xyChart: {
              ...
              titleColor: '#64ffda',
              xAxisTitleColor: '#f4f4f5',
              xAxisLabelColor: '#a1a1aa',
              xAxisLineColor: '#3f3f46',
              yAxisTitleColor: '#f4f4f5',
              yAxisLabelColor: '#a1a1aa',
              yAxisLineColor: '#3f3f46',
              plotColorPalette: '#64ffda, #38bdf8, #818cf8, #34d399, #fbbf24, #f43f5e',
            },
          }
        : {
            darkMode: false,
            ...
            // Pie chart colors (clean, high-contrast light mode palette)
            pie1: '#0d9488',
            pie2: '#0284c7',
            pie3: '#4f46e5',
            pie4: '#059669',
            ...
            xyChart: {
              ...
              plotColorPalette: '#0d9488, #0284c7, #4f46e5, #059669, #d97706, #e11d48',
            },
          },
      securityLevel: 'loose',
