---
title: "अपने डॉकर इमेज का आकार घटाएं: मल्टी-स्टेज बिल्ड की शक्ति"
description: "मल्टी-स्टेज डॉकर बिल्ड उत्पादन इमेज का आकार कैसे घटाते हैं, गो, नोड, जावा और पायथन पर असली बेंचमार्क के साथ।"
date: 2026-01-02
...
* **गिटहब रिपॉजिटरी:** [मल्टी-स्टेज डॉकर बेंचमार्किंग](https://github.com/breejesh/multi-stage-docker-benchmarking)
...
2. **प्री-बिल्ट बेस:** निर्भरताएँ एक कस्टम बेस में रहती हैं। एप्लिकेशन बिल्ड इसके ऊपर स्रोत कोड कॉपी करता है। अंतिम इमेज भारी बनी रहती है।
3. **मल्टी-स्टेज:** बिल्डर में एसडीके रहता है; अंतिम चरण में केवल आवश्यक आर्टिफैक्ट (बाइनरी, `dist/`, जार फ़ाइल या वातावरण का आवश्यक भाग) जाता है।
...
![रणनीति के अनुसार अंतिम इमेज आकार](https://raw.githubusercontent.com/breejesh/multi-stage-docker-benchmarking/refs/heads/main/assets/chart_size.png)

![कोल्ड / अनकैश्ड बिल्ड समय](https://raw.githubusercontent.com/breejesh/multi-stage-docker-benchmarking/refs/heads/main/assets/chart_cold.png)

![कोड-संपादन पुनर्निर्माण समय](https://raw.githubusercontent.com/breejesh/multi-stage-docker-benchmarking/refs/heads/main/assets/chart_incremental.png)

![निर्भरता-मैनिफेस्ट परिवर्तन पुनर्निर्माण समय](https://raw.githubusercontent.com/breejesh/multi-stage-docker-benchmarking/refs/heads/main/assets/chart_dependency.png)

### इमेज का आकार (मल्टी-स्टेज की जीत)

| स्टैक | सिंगल-स्टेज | प्री-बिल्ट | मल्टी-स्टेज | सिंगल के मुकाबले गिरावट |
|---|---:|---:|---:|---:|
| गो | 69.2 एमबी | 69.2 एमबी | **5.4 एमबी** | **~92%** |
| नोड.जेएस (टाइपस्क्रिप्ट) | 64.3 एमबी | 64.3 एमबी | **47.4 एमबी** | **~26%** |
| जावा (फैट जार) | 231.7 एमबी | 231.7 एमबी | **69.9 एमबी** | **~70%** |
| पायथन (कॉन्डा) | 355.1 एमबी | 355.1 एमबी | **85.7 एमबी** | **~76%** |
...
गो में सबसे बड़ा अंतर दिखा: अल्पाइन अथवा `scratch` जैसे न्यूनतम रनर पर केवल स्टेटिक बाइनरी रखने से बाकी सब हट जाता है। नोड में कमी थोड़ी कम होती है क्योंकि उत्पादन में नोड रनटाइम और `node_modules` की आवश्यकता बनी रहती है।
...
### `scratch` अथवा डिस्ट्रोलेस का उपयोग
...
|---|---|---|---|---|
| `alpine:3.20` | ~7 एमबी | ✅ | ✅ (`apk`) | सामान्य उपयोग, डिबगिंग |
| `distroless/static` | ~2 एमबी | ❌ | ❌ | उत्पादन गो, रस्ट, सी++ |
| `scratch` | 0 एमबी | ❌ | ❌ | अधिकतम सुरक्षा, स्टेटिक बाइनरी |
