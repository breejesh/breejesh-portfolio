...
### 1. 100% मुफ्त और ओपन-सोर्स (एफओएसएस)
...
सभी भोजन विश्लेषण और मैक्रोज़ का अनुमान डिवाइस-पर किया जाता है। **गूगल जेमा-2बी** और गूगल के **लाइटआरटी** रनटाइम द्वारा संचालित, ऐप सीधे आपके फोन के अंदर प्राकृतिक भाषा इनपुट को पार्स करता है। मुख्य कार्यक्षमता के लिए कभी भी इंटरनेट कनेक्शन की आवश्यकता नहीं होती है।
...
<p align="left">
  <img src="https://raw.githubusercontent.com/breejesh/nom.ai/refs/heads/main/doc-images/home-light.png" width="260" alt="लाइट डैशबोर्ड">
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="https://raw.githubusercontent.com/breejesh/nom.ai/refs/heads/main/doc-images/home-dark.png" width="260" alt="डार्क डैशबोर्ड">
</p>
...
<p align="left">
  <img src="https://raw.githubusercontent.com/breejesh/nom.ai/refs/heads/main/doc-images/input-methods.png" width="180" alt="इनपुट विधि चुनें">
  &nbsp;&nbsp;
  <img src="https://raw.githubusercontent.com/breejesh/nom.ai/refs/heads/main/doc-images/pompt-add.png" width="180" alt="एआई से वर्णन करें">
  &nbsp;&nbsp;
  <img src="https://raw.githubusercontent.com/breejesh/nom.ai/refs/heads/main/doc-images/image-add.png" width="180" alt="विज़न से फोटो लें">
  &nbsp;&nbsp;
  <img src="https://raw.githubusercontent.com/breejesh/nom.ai/refs/heads/main/doc-images/meal-breakdown.png" width="180" alt="भोजन विभाजन">
</p>
...
<p align="left">
  <img src="https://raw.githubusercontent.com/breejesh/nom.ai/refs/heads/main/doc-images/dashboard.png" width="240" alt="डैशबोर्ड विश्लेषण">
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="https://raw.githubusercontent.com/breejesh/nom.ai/refs/heads/main/doc-images/journal.png" width="240" alt="भोजन जर्नल">
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="https://raw.githubusercontent.com/breejesh/nom.ai/refs/heads/main/doc-images/settings.png" width="240" alt="ऐप सेटिंग्स">
</p>
...
1. **जेसन सत्यापन:** प्रत्येक प्रतिक्रिया को एक सख्त जेसन डीसेरियलाइज़र के साथ पार्स किया जाता है। यदि पार्सिंग विफल हो जाती है, तो प्रॉम्प्ट को और अधिक सीमित प्रारूप के साथ पुन: प्रयास किया जाता है।
2. **सत्यता जांच:** अनुमानित कैलोरी को उचित सीमाओं के भीतर सत्यापित किया जाता है (उदाहरण के लिए, 10,000 कैलोरी वाले किसी एक खाद्य पदार्थ को अस्वीकार कर दिया जाता है)। मैक्रो योगों को कुल कैलोरी संख्या के साथ जांचा जाता है (कैलोरी ≈ प्रोटीन×4 + कार्ब्स×4 + फैट×9)।
...
* **लाइटआरटी-एलएम एसडीके:** गूगल का उच्च-प्रदर्शन जेनेरेटिव एआई रनटाइम, जो न्यूनतम बैटरी खपत के साथ जेमा मॉडल चलाने के लिए हार्डवेयर त्वरण (जीपीयू/एनपीयू) का उपयोग करता है। यूआई थ्रेड को मुक्त रखने के लिए मॉडल `Dispatchers.IO` पर चलता है।
...
### अस्पष्ट मात्रा
जब कोई उपयोगकर्ता कहता है *\"मैंने थोड़ा चावल खाया\"*, तो \"थोड़ा\" चावल कितना है? मॉडल डिफ़ॉल्ट रूप से यूएसडीए मानक सर्विंग साइज़ (1 कप पका हुआ, ~200 ग्राम) का उपयोग करता है, लेकिन उपयोगकर्ता का आशय भिन्न हो सकता है।
...
### मेमोरी का दबाव
एक पूर्ण कंपोज़ यूआई, रूम डेटाबेस और संभावित रूप से अन्य ऐप्स के साथ 2बी पैरामीटर मॉडल चलाना डिवाइस की मेमोरी पर भारी दबाव डालता है। 6 जीबी रैम वाले उपकरणों पर, ऐप को संसाधनों को रिलीज़ करने में आक्रामक होना पड़ता है, जैसे इमेज कैशे साफ़ करना और मेमोरी प्रेशर कॉलबैक की निगरानी करना।
...
मॉडल फ़ाइल ~1.4 जीबी की है, इसे सीधे एपीके में शामिल नहीं किया जा सकता। नोमएआई इसे पहले लॉन्च पर डाउनलोड करता है, जो उपयोगकर्ता अनुभव के लिए एक संवेदनशील क्षण होता है।
...
सोर्स कोड [गिटहब](https://github.com/breejesh/nom.ai) पर पूरी तरह से ओपन-सोर्स है। यदि आप डिवाइस-पर एआई, ऑफ़लाइन-प्रथम आर्किटेक्चर में रुचि रखते हैं, या सिर्फ एक ऐसा कैलोरी ट्रैकर चाहते हैं जो आपका डेटा न बेचे, तो इसे देखें और योगदान करने पर विचार करें।
