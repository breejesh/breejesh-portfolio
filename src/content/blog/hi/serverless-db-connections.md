...
description: "एडब्ल्यूएस लैम्ब्डा में डेटाबेस कनेक्शन की समाप्ति से कैसे बचें और कनेक्शन पूल को प्रभावी ढंग से कैसे प्रबंधित करें।"
date: 2026-01-03
...
एक पारंपरिक सर्वर आर्किटेक्चर में, एक एकल एप्लिकेशन इंस्टेंस एक कनेक्शन पूल (उदाहरण के लिए, 20 कनेक्शन) स्थापित करता है और इसे सभी समवर्ती अनुरोधों में साझा करता है। लोड बैलेंसर के पीछे तीन इंस्टेंस का मतलब कुल 60 डेटाबेस कनेक्शन हैं, जो पूरी तरह से अनुमानित और प्रबंधनीय हैं।
...
* अधिकांश पोस्टग्रेएसक्यूएल इंस्टेंस डिफ़ॉल्ट रूप से `max_connections = 100` पर सेट होते हैं। एक आरडीएस `db.t3.medium` लगभग **150 कनेक्शन** का समर्थन करता है। आपके 1,000 लैम्ब्डा इंस्टेंस लगभग तुरंत इस सीमा को पार कर जाएंगे, जिससे `FATAL: too many connections` त्रुटियां मिलेंगी।
...
## रणनीति 1: वॉर्म इनवोकेशन्स में कनेक्शन का पुन: उपयोग
...
**महत्वपूर्ण विवरण:**
- **पैरामीटराइज्ड क्वेरीज़** (`$1`) एसक्यूएल इंजेक्शन को रोकती हैं। उपयोगकर्ता इनपुट को सीधे क्वेरी स्ट्रिंग में कभी न जोड़ें।
...
**यह कैसे काम करता है:**
1. आपका लैम्ब्डा फ़ंक्शन सीधे डेटाबेस के बजाय आरडीएस प्रॉक्सी एंडपॉइंट से जुड़ता है।
2. आरडीएस प्रॉक्सी वास्तविक डेटाबेस के लिए लंबे समय तक चलने वाले कनेक्शनों का एक पूल बनाए रखता है (जैसे, 50 कनेक्शन)।
3. जब लैम्ब्डा कंटेनर ए एक क्वेरी भेजता है, तो प्रॉक्सी पूल से एक कनेक्शन लेता है, क्वेरी चलाता है, और कनेक्शन को वापस पूल में डाल देता है।
4. लैम्ब्डा कंटेनर बी की क्वेरी कुछ पलों बाद उसी कनेक्शन का पुन: उपयोग करती है।
...
**लागत:** आरडीएस प्रॉक्सी प्रति प्रॉक्सी ~$15-25/माह (इंस्टेंस टाइप के आधार पर) और साथ ही $0.015 प्रति वीसीपीयू-घंटा चार्ज करता है। बड़े डिप्लॉयमेंट के लिए, यह विकास समय और स्थिरता की तुलना में नगण्य है।
...
**डिप्लॉयमेंट विकल्प:**
- **ईसी2/ईसीएस पर साइडकार:** अपने डेटाबेस के समान वीपीसी में एक छोटे इंस्टेंस पर पीजीबाउंसर चलाएं। लैम्ब्डा पीजीबाउंसर से जुड़ता है; पीजीबाउंसर डेटाबेस से जुड़ता है।
...
|---|---|---|---|---|---|
| **एडब्ल्यूएस आरडीएस प्रॉक्सी** | प्रबंधित | ✅ | ✅ | ~$20/माह + वीसीपीयू घंटे | एडब्ल्यूएस-नेटिव, नो-ऑप्स |
| **पीजीबाउंसर** | स्व-प्रबंधित | ✅ | ❌ | केवल ईसी2 इंस्टेंस लागत | पूर्ण नियंत्रण, मल्टी-क्लाउड |
...
यदि आप अपने लैम्ब्डा फ़ंक्शन के अंदर ओआरएम या कनेक्शन पूल लाइब्रेरी का उपयोग कर रहे हैं, तो अधिकतम पूल आकार (`max`) को **1** पर सेट करें। यदि आप पारंपरिक सर्वर पृष्ठभूमि से आ रहे हैं तो यह अजीब लग सकता है, लेकिन लैम्ब्डा के लिए यही सही है:

```javascript
// लैम्ब्डा के लिए नेक्स.जेएस कॉन्फ़िगरेशन
...
**`max: 1` क्यों?** एक अकेला लैम्ब्डा कंटेनर एक समय में बिल्कुल एक ही अनुरोध को प्रोसेस करता है। एक कंटेनर के अंदर कोई समवर्ती प्रसंस्करण नहीं होता है, इसलिए 10 कनेक्शन का पूल रखने का मतलब है कि 9 हमेशा निष्क्रिय रहेंगे और आपके डेटाबेस के `max_connections` सीमा को व्यर्थ में भरेंगे।
...
**लागत:** आप प्रोविजंड कंटेनरों के लिए भुगतान करते हैं भले ही वे निष्क्रिय हों (~$0.0000041667/जीबी-सेकंड)। 50 प्रोविजंड इंस्टेंस के साथ 512 एमबी फ़ंक्शन के लिए, यह लगभग **$2.70/दिन** है। उत्पादन एपीआई के लिए यह लागत सार्थक है; बैच जॉब्स के लिए यह अनावश्यक है।
...
* **`DatabaseConnections`** (आरडीएस मीट्रिक): जब कनेक्शन `max_connections` के 80% से अधिक हो जाएं तो अलर्ट भेजें। यह विफलता शुरू होने से पहले सुधार का समय देता है।
...
2. लैम्ब्डा समवर्ती प्रसंस्करण को डेटाबेस कनेक्शन से अलग करने के लिए एक **कनेक्शन प्रॉक्सी** (आरडीएस प्रॉक्सी या पीजीबाउंसर) का उपयोग करें।
