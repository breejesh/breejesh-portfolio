...
You walk into an interview and get handed problem **16.7**: find maximum of two integers without using if-else or comparison operators using bitwise sign shift. The naive solution is obvious, but production constraints demand optimal time and space. Here is the exact mental model, the code that works, and the traps that catch candidates off guard.
