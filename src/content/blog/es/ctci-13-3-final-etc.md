...
> **TL;DR**
> * **El Problema:** Mecánica técnica del problema CTCI 13.3.
> * **El Enfoque:** CTCI problem 13.3: clear distinction between final variable/method/class, try-finally block, and Object.finalize().
> * **Complejidad:** Relación óptima de tiempo y memoria.

Este artículo explica claramente el problema CTCI **13.3**.
