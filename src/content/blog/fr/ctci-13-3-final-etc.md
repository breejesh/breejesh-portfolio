...
> **TL;DR**
> * **Le Problème:** Mécanique technique du problème CTCI 13.3.
> * **L'Approche:** CTCI problem 13.3: clear distinction between final variable/method/class, try-finally block, and Object.finalize().
> * **Complexité:** Empreinte mémoire et temps optimaux.

Cet article explique clairement le problème CTCI **13.3**.
